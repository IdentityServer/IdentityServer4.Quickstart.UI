...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
            ...
            TestUserStore users = null)
        {
            ...
            _events = events;
            _account = new AccountService(interaction, authenticationSchemeProvider, httpContextAccessor, clientStore);
        }
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var info = await _authenticationService.AuthenticateAsync(HttpContext, IdentityServerConstants.ExternalCookieAuthenticationScheme);
